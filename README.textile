...
If a client with a smaller resolution disabled javascript, this plugin won't work. So you can create different default widths for images in different situations. For examples please have a look in the css file _css_styled_content.css_.
